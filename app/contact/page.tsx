  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col lg:flex-row w-full md:flex items-start justify-evenly bg-primary-gradient text-white lg:py-32 py-11 px-content-padding-sm lg:px-24">
          ...
          <div className="w-full mt-16 lg:mt-0 lg:px-10">
