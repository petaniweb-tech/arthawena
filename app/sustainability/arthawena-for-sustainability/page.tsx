    ...
    <>
        ...
        <div className="px-content-padding-sm lg:px-content-padding-lg 2xl:px-content-padding-2xl">
          <div className="text-left mb-12 lg:mb-20 lg:flex lg:space-x-12 lg:justify-between">
            ...
            <div className="lg:w-1/3 lg:mt-8">
              <h2 className="text-sm lg:text-xl text-charcoal text-opacity-80 lg:tracking-normal lg:text-opacity-100 uppercase lg:capitalize tracking-wider">We Grow</h2>
              <h3 className="text-4xl lg:text-7xl font-aeonik-regular lg:font-aeonik-medium text-primary mt-2 mb-8 lg:mt-2">Excellent</h3>
            </div>

            {/* Right Column: Description */}
            <div className="lg:w-1/2">
              <p className="text-[15px] lg:text-[17px] text-charcoal mt-4 leading-relaxed font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div>
              <Image src={IcCo2} alt="CO2 Icon" width={120} height={120} className="mx-auto mb-4 lg:mb-8 lg:h-[120px] w-auto" />
              <h4 className="text-lg mb-4 tracking-wider">REDUCE GHG EMISSION <br /> INTENSITY 0.005 in 2023</h4>
              <p className="text-sm text-charcoal">in Tons CO₂eq / 1000 pcs</p>
            </div>
            <div>
              <Image src={IcReuse} alt="Reuse Icon" width={120} height={120} className="mx-auto mb-4 lg:mb-8 lg:h-[120px] w-auto" />
              <h4 className="text-lg mb-4 tracking-wider">REUSE ACTIVITY ON <br /> AVERAGE RATE 96%</h4>
            </div>
            <div>
              <Image src={IcTech} alt="Technology Icon" width={120} height={120} className="mx-auto mb-4 lg:mb-8 lg:h-[120px] w-auto" />
              <h4 className="text-lg mb-4 tracking-wider">NEWEST TECHNOLOGY <br /> ENABLE TO USE 10-14% <br /> LESS MATERIAL </h4>
        ...
        <div className="px-content-padding-sm lg:px-content-padding-lg 2xl:px-content-padding-2xl">
          <div className="text-left mb-12 lg:flex lg:space-x-12 lg:justify-between">
            ...
            <div className="lg:w-1/2 mb-8 lg:mb-0 lg:mt-12">
              <h2 className="text-sm text-opacity-80 lg:text-xl text-charcoal uppercase lg:tracking-normal lg:text-opacity-100  lg:capitalize tracking-wider">We Evolve</h2>
              <h3 className="text-4xl lg:text-7xl font-aeonik-regular lg:font-aeonik-medium text-primary mt-2 mb-8 lg:mt-2">Service</h3>
            </div>

            {/* Right Column: Description and Button */}
            <div className="lg:w-1/2">
              <p className="text-[15px] lg:text-[17px] text-charcoal mt-8 leading-relaxed font-light">
              ...
              <p className="text-[15px] lg:text-[17px] text-charcoal mt-4 font-light leading-relaxed">
              ...
              {/* Button */}
              <div className="mt-8 mb-14 lg:mb-[70px]">
                <a href="#!" className="text-[15px] tracking-wider inline-block text-primary border border-primary py-1 px-4 rounded-full">
                  READ OUR CULTURE
                </a>
              </div>
            </div>
      ...
      <section>
        ...
        <div className="px-content-padding-sm lg:px-content-padding-lg 2xl:px-content-padding-2xl lg:flex lg:space-x-12">
          ...
          {/* Left Column: Title and Subtitle */}
          <div className="lg:w-1/2 mb-8 lg:mb-0 lg:mt-12">
            <h2 className="text-sm lg:text-xl text-charcoal text-opacity-80 uppercase lg:tracking-normal lg:text-opacity-100  lg:capitalize tracking-wider">We Care</h2>
            <h3 className="text-4xl lg:text-7xl font-aeonik-regular lg:font-aeonik-medium text-primary mt-2 mb-8 lg:mt-2">Accountability</h3>
          </div>

          {/* Right Column: Description and Button */}
          <div className="lg:w-1/2">
            <p className="text-[15px] lg:text-[17px] text-charcoal mt-8 font-light leading-relaxed">
            ...
            <p className="text-[15px] lg:text-[17px] text-charcoal mt-6 font-light leading-relaxed">
            ...
            {/* Button */}
            <div className="text-start mt-8 mb-16 lg:mb-24">
              <a href="#!" className="text-[15px] tracking-wider inline-block text-primary border border-orange-500 py-1 px-4 rounded-full">
                READ CSR PROGRAMS
              </a>
            </div>
          </div>
      ...
      <section>
        <div className="px-content-padding-sm lg:px-64 grid grid-cols-1 sm:grid-cols-3 gap-10 text-center">
          {/* Minimize Waste */}
          <div>
            <Image src={IcMinimizeWaste} alt="Minimize Waste Icon" width={120} height={120} className="mx-auto mb-10 lg:h-[120px]" />
            <h4 className="text-lg tracking-wider mb-2 text-charcoal">MINIMIZE WASTE</h4>
          </div>

          {/* Greener */}
          <div>
            <Image src={IcGreener} alt="Greener Icon" width={120} height={120} className="mx-auto mb-10 lg:h-[120px]" />
            <h4 className="text-lg tracking-wider mb-2 text-charcoal">GREENER</h4>
          </div>

          {/* Corporate Social Responsibility */}
          <div>
            <Image src={IcCorporate} alt="Corporate Social Responsibility Icon" width={120} height={120} className="mx-auto mb-10 lg:h-[120px]" />
            <h4 className="text-lg tracking-wider mb-28 lg:mb-32 text-charcoal">CORPORATE SOCIAL <br /> RESPONSIBILITY</h4>
          </div>
        </div>
      </section>
    </>
